		...
		<motion.div
			...
			<div className="flex items-start justify-between mb-3">
				<div className="flex items-center space-x-2">
					<div className="p-2 bg-gray-100 rounded-lg">{getContentIcon()}</div>
					<div>
				...
				<span
					className={`text-xs px-2 py-1 rounded-full capitalize ${getStageColor()}`}>
					{content.stage}
				</span>
			</div>
			...
			<div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100">
				...
				{content.stage !== "PUBLISHED" && content.stage !== "ARCHIVED" && (
					<button
